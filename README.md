...
|------|----------------|
| `users` | TRAN TIEN DAT  |
| `departments` | TRAN TIEN DAT  |
| `ticket_categories` | TRAN TIEN DAT  |
| `tickets` | DO HUONG GIANG  |
| `ticket_assignments` | DO HUONG GIANG  |
| `ticket_comments` | DO HUONG GIANG  |
| `ticket_status_logs` | VI XUAN DUC ANH  |
| `escalation_logs` | VI XUAN DUC ANH  |
| `satisfaction_surveys` | VI XUAN DUC ANH  |
